...
| **3. Use ML model**          | `mdck_model.py` | In our example, a model for **MDCK permeability** specifically design for cyclic peptides was trained with Schrodinger AutoQSAR, using 3D PSA and standard property-based descriptors. The training set was based on 328 cyclic peptides from http://cycpeptmpdb.com |
