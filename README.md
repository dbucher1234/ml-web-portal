...
|------|-----------------|-----------------|
| **1. SMILES → conformers**     | `gen_conf.py` | Open-source RDKit (ETKDG + UFF) is used to sample 100 conformers and select the lowest-energy one, providing a fast but replaceable method for generating reasonable 3D structures. 
